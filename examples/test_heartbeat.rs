...
async fn main() -> anyhow::Result<()> {
    ...
    let hb_config = uniclaw::agent::HeartbeatConfig::default();
    ...
    match &result {
        ...
        uniclaw::agent::HeartbeatResult::Failed(err) => {
